...
//Method takes parameter approach:


  //Method takes a parameter approach:
    static int[] arr = {10, 20, 7, 8, 90};

    /**
     * Method accepts an integer array parameter returns elements from that array in descending order
     * @param in
     * @return
     */
    public static List<Integer> descendingArr(int[] in) {
...
//        System.out.println("Numbers from the array sorted in descending order are: " + descendingArr());
        ...
        //Method takes a parameter approach:
        System.out.println("Numbers from the array sorted in descending order are: " + descendingArr(arr));
